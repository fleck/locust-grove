...
## HVAC Requirements
- 1 zone per floor.
- **Proposed Unit Sizing:**
    - First Floor: 2.5 Ton
    - Second Floor: 1.5 Ton
    - *Note: Sizing is preliminary and must be confirmed by the HVAC Contractor.*
- **Duct Insulation:** Insulate plenum and branch supply ducts in basement, attics, and garages.


## Plumbing Requirements
- **System Type:** Hybrid home run system.
- **Manifold:** Central manifold (Contractor option: Site-built or Pre-Manufactured).
- **Trunk Lines (Manifold to Room):**
    - Hot: 1/2" run to each room/group.
    - Cold: 3/4" run to each room/group.
...
- **Basement :** See Basement Floor Plan page for water and sewer service locations and basement rough ins.
- **Basement Vent :** Run vent from basement to attic vent system to serve future basement toilet/shower.
